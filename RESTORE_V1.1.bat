@echo off
echo ========================================
echo Restoring to Version 1.1
echo ========================================
echo.
echo This will checkout version 1.1 of the project.
...
if %ERRORLEVEL% EQU 0 (
    echo.
    echo ========================================
    echo Successfully restored to Version 1.1
    echo ========================================
    echo.
    ...
    echo.
    echo ========================================
    echo ERROR: Failed to restore to Version 1.1
    echo ========================================
    echo.
