# Verify v3.3 Backup Status on Both Drives

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Verifying v3.3 Backup Status" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""

$dDrive = "D:\3d-viever-backup\v3.3"
$fDrive = "F:\3d-viever-backup\v3.3"
$version = "v3.3"
