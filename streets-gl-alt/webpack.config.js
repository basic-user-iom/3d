...
module.exports = (env, argv) => ([{
	...
	devServer: {
		...
		// Allow this app to be embedded in the 3D viewer iframe (viewer uses COEP require-corp)
		headers: {
		...
		setupMiddlewares: (middlewares, devServer) => {
			...
			// Ensure COEP/CORP on every response so iframe can be embedded in viewer (viewer uses COEP require-corp)
