...
export default class WebGL2Framebuffer {
	...
	public bindAttachments(): void {
		...
		if (this.depthAttachment) {
			...
			let layer = this.depthAttachment.slice ?? 0;
