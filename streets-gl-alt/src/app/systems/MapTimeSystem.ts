...
// [sunDirection, moonDirection]. sunDirection.y < 0 => sun (intensity 10), y >= 0 => moon (intensity 0). Presets: 0=Morning, 1=Noon, 2=Evening.
const StaticPresets: [Vec3, Vec3][] = [
	...
	[new Vec3(0.3, 0.02, -0.95).normalize(), new Vec3(-1, -1, -1).normalize()]
];
