# Verify v3.8 Backup Status on Both Drives

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Verifying v3.8 Backup Status" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""

$dDrive = "D:\3d-viever-backup\v3.8"
$fDrive = "F:\3d-viever-backup\v3.8"
$version = "v3.8"
